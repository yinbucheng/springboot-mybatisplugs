...
AnnotatedBeanDefinitionReader  1.注册内置BeanPostProcessor 2.注册内置的BeanFactoryPostProcessor(比如ConfigurationClassPostProcessor,AutowiredAnnotationBeanPostProcessor)   2.注册相关的BeanDefinition
